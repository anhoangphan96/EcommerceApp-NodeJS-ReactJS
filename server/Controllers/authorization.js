//Check author của client thì chỉ cần có role và đã đăng nhập là được truy cập
...
//Check author của counselor thì phải là admin  và đã đăng nhập là được truy cập
